...
const Heart = ({ size, color, ...props }) => (
  <svg {...props} viewBox="0 0 24 24" width={size} height={size} fill={color}>
    <path d="M20.08,12.49a4.87,4.87,0,0,0,1.54-3.63,4.9,4.9,0,0,0-1.54-3.63,5,5,0,0,0-3.53-1.5A5.06,5.06,0,0,0,13,5.06L12,5.92l-.95-.86a5.06,5.06,0,0,0-3.6-1.33,5,5,0,0,0-3.53,1.5A4.91,4.91,0,0,0,2.37,8.86a4.88,4.88,0,0,0,1.55,3.63L11.53,20a.55.55,0,0,0,.94,0Z" />
